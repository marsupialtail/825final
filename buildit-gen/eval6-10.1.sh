...
/data/scratch/ziheng/cuda-10.1/bin/nvcc  -std=c++11 -I -Xcompiler "-w" -Wno-deprecated-gpu-targets -gencode arch=compute_61,code=sm_61 --use_fast_math -Xptxas "-v -dlcm=ca" driver.cu -I build/dir_$1_$2_$3_$4 -o build/dir_$1_$2_$3_$4/run -I /data/scratch/ziheng/cnpy/ -L /data/scratch/ziheng/cnpy/build/ -lcnpy -O3 
